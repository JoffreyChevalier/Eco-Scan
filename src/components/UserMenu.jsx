function UserMenu() {
    return (  <!-- component -->
        <div className="h-screen bg-gray-200 flex justify-center items-center dark:bg-gray-500">
          <div x-data="{ open: false }" className="bg-white dark:bg-gray-800 w-64  shadow flex justify-center items-center">
              <div @click="open = !open" className="relative border-b-4 border-transparent py-3" :className="{'border-indigo-700 transform transition duration-300 ': open}" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100">
